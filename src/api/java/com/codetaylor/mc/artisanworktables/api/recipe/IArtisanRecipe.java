...
public interface IArtisanRecipe {
   ...
   */
  @Nullable
  <C extends IRequirementContext> IRequirement<C> getRequirement(ResourceLocation resourceLocation);
  ...
  void damageTools(IItemHandlerModifiable toolStackHandler, World world, @Nullable PlayerEntity player, BlockPos position, @Nullable IItemHandler toolReplacementHandler);
}
