...
public class GuiElementButtonExportShaped
  ...
  public void elementClicked(double mouseX, double mouseY, int mouseButton) {
    ...
    try {
      String data = ZSRecipeExport.getExportString((BaseContainer) gui.inventorySlots, tileEntity, true);
  ...
  public List<ITextComponent> tooltipTextGet(List<ITextComponent> list) {
    ...
    list.add(new TranslationTextComponent("gui.artisanworktables.tooltip.button.export.shaped"));
    return list;
  }
